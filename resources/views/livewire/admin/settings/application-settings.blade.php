<div>
    ...
    <div class="card">
        ...
        <x-form wire:submit="update" method="put">
            ...
            <fieldset class="mb-3 w-full max-w-md">

                <div class="mt-1 bg-white dark:bg-gray-500 dark:text-gray-200 rounded-md shadow-sm -space-y-px">

                    <div class="relative border rounded-md p-4 flex border-gray-200">
                        <div class="flex items-center h-5">
                            <input wire:model="allowRegistration" id="allowRegistration" type="checkbox" class="h-4 w-4 text-light-blue-600 cursor-pointer focus:ring-light-blue-500 border-gray-300">
                        </div>
                        <label for="allowRegistration" class="ml-3 flex flex-col cursor-pointer">
                                <span class="block text-sm font-medium text-gray-900 dark:text-gray-300">
                                    {{ __('Enable register') }}
                                </span>
                            <span class="block text-sm text-gray-500 dark:text-gray-200">
                                    {{ __('Allow users to view the registration page and complete their registration.') }}
                                </span>
                        </label>
                    </div>
