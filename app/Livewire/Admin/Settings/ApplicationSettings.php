...
class ApplicationSettings extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->allowRegistration = (bool) (Setting::where('key', 'allow_registration')->value('value') ?? true);
    }
    ...
    public function update(): void
    {
        ...
        Setting::updateOrCreate(['key' => 'allow_registration'], ['value' => $this->allowRegistration]);
